...
export default function Home() {
  ...
  function reconsiderLatestEcho() {
    const latestAllowed = entries.find(entry => entry.aiLink);
    if (!latestAllowed) return notify("还没有允许关联的记录");
