...
export default function Home(){
  ...
  const writeRows=Math.max(6,writeLineCount+(writeLineCount<15?3:0));
  const editLineCount=visualLineCount(edit?.content||"",55);
  const editRows=Math.max(6,editLineCount+(editLineCount<15?3:0));
