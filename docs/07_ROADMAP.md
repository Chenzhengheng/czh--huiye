...
- [x] Agent Prompt v0.3：主线内搜索、最小充分来源、单一候选或保持沉默
- [x] 本地兼容存储、测试和核心文档
...
Agent Prompt v0.3 已完成一条新 good case 的首轮验证：它从完整主思考线中选择未使用过的最小来源组合，三个评测维度均为高。当前 10 个 Case 共 7 个 good、3 个 bad；私人原文和逐条评测仍只保存在本地。
...
3. 作品集的信息架构、内容选择与发布方式另行讨论；当前只有“回页本体、可公开笔记、思考线 Case、回响 Case、完整评测、GitHub 链接、产品流程图”这一讨论起点，不代表最终方案。
4. 作品集方向确认后，再整理项目简历表述。
